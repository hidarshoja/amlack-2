<template>
  ...
  >
    <h3 class="flex gap-1 items-center">
      <span class="text-gold1 font-semibold"> پرفایل متخصص</span>
    ...
    <div class="flex gap-4 mb-4 mt-8 flex-col lg:flex-row">
      ...
      <button
        ...
        :class="{
          'bg-green-600 text-white text-sm': activeTab === 'form2',
          'bg-gray-200 text-sm': activeTab !== 'form2',
        }"
        class="px-4 py-2 rounded"
      >
        بیوگرافی و تخصص ها
    ...
    <div v-if="activeTab === 'form2'" class="form2">
      <form action="#" method="POST" className="space-y-6 mt-10">
        <div className="flex flex-col md:flex-row gap-1">
          <div className="w-full md:w-1/2">
            <label
        ...
        <div className="w-full mt-4">
            <ul class="w-full bg-white  rounded-lg">
            <li v-for="(experience, index) in jobExperiences" :key="index" class="mb-4 bg-gray-200 p-2 flex items-center justify-between">
                <span>

                    {{ index + 1 }}. {{ experience }}
                </span>
                <button
                @click="removeJobExperience(index)"
