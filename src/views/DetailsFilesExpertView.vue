<template>
    ...
    >
      ...
      <div class="w-full flex flex-col lg:flex-row mt-10 gap-2">
        ...
        <div class="w-full flex flex-col lg:w-1/3 px-3 gap-4">
            <router-link
            to="/expertPage/ChatExpert"
              class="w-full flex items-center justify-center cursor-pointer bg-green-500 py-2 rounded-lg text-white hover:bg-green-700"
